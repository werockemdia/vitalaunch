...
function wphelp_update_cart_when_changing_quantities() {
    ...
    <div id="loader"> </div>
    <p style="  position: absolute; margin-top: 200px; font-weight: 800; ">Please wait your Label is Generating </p>
</div>
<style>
    /* Loader Styles */
#loader-wrapper {
...
.inputDiv .tooltip .question {
  ...
  var bb= $('#static_path1').val();
          ...
          if(a){
          ...
          else if(   bb == "background.png"){
           //else if(   bb == "https://vitalaunch.io/product/gummies/?qty=2"){
              var cc ="https://vitalaunch.io/wp-content/uploads/background.png";
              ...
              $('#static_path').val('background.png');
           ...
           //else if(   bb == "https://vitalaunch.io/product/capsules/?qty=2"){
              ...
              var cc ="https://vitalaunch.io/wp-content/uploads/basic-bottle.png";
               $('.canvasDiv a').removeAttr("href");
   ...
   // if($productID == "4746"){
	...
	<div class="row cus_button">
	 ...
	 <div class="con_content_1">
        ...
        <b>Step 2: Upload label PNG</b>
        <p>Upload a print quality PNG file. The product image above will refresh automatically</p>
        ...
        <!-- <div style="display:block;width:120px; height:30px;" onclick="document.getElementById('getFile').click()">Upload PDF</div>
         ...
         <input type="text" name="static_path1" id="static_path1" value="<?php echo $mergeimage;?>" />
...
{  
    echo "<script>console.log('checking');</script>";
       // $staticImagePath = $_SERVER['DOCUMENT_ROOT']."/wp-content/uploads/background.png" ; // Path to the static image
        $staticImagePath = $_SERVER['DOCUMENT_ROOT']."/wp-content/uploads/" .$_POST['static_path1'];
    ...
    echo 'User is a vendor.'.$user_id . "<br/>";
     ...
     $site_id =  get_user_meta( $user_id, 'primary_blog', true );
         ...
         $ss1 = $_POST['static_path1'];
           //  if($ss1 == "background.png"){ mergeImages($staticImagePath, $targetFile2, $mergedFile, 7.9, 200 , 0); }
            if($ss1 == "background.png"){
                $thirdImage = $_SERVER['DOCUMENT_ROOT']."/wp-content/uploads/background-transparent.png"; 
                  mergeImagesWithThirdImage($staticImagePath, $targetFile2, $mergedFile, $thirdImage, 0.5, 90, 0);
            }
                  ...
                  mergeImagesWithThirdImage($staticImagePath, $targetFile2, $mergedFile, $thirdImage, 1.2, 90, 0); }
          ...
          // mergeImages($staticImagePath, $targetFile2, $mergedFile, 7.9, 200);
           mergeImages($staticImagePath, $targetFile2, $mergedFile, 1.2, 250,270); }
            ...
            $img2 = "https://vitalaunch.io/wp-content/uploads/merged_image-".basename($_FILES["file"]["name"]);
                ...
                $src = media_sideload_image( $img2, null, null, 'src' ); 
                ...
                if( $image_id ) {
                    ...
                    if( $image) {
                        ...
                        wp_post_meta('$p_id', '_thumbnail_id', $im_id);*/
