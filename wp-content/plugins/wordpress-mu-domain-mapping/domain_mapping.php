...
function dm_manage_page() {
	...
	if ( get_site_option( 'dm_cname' ) ) {
	    ...
	    <style>
            ...
            .close1:hover, .close2:hover,  #popup1:hover, #popup2:hover  {
            	cursor: pointer;
            }
            #popup1, #popup2 {
            	border-radius: 30px;
	    ...
	    jQuery(document).ready(function(){
              ...
              $(".cover2,.close2").click(function(){
                $(".cover2").fadeOut("300");
              });
              $(".contents2").click(function(e){
                e.stopPropagation();
              });
            });
	    </script>
	    <div class="cover1">
          <div class="contents1">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/C0DPdy98e4c?si=HYz2aegCSt8Fzq9E" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        ...
        <div class="cover2">
          <div class="contents2">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/uSY9Ix-7wFk?si=o6lvvooWcs5sF4Xb" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
		...
		echo "<p>" . __( 'Go to your domain provider and change DNS records', 'wordpress-mu-domain-mapping' ) . "</p>";
		echo "<p>" . __( 'You have two options to update your domain, X.vitalaunch.io. You can either change the nameservers or adjust the IP in the DNS settings. Please ensure that you have purchased the domain from a domain provider like GoDaddy, Wordpress, Hostinger, etc., before proceeding.', 'wordpress-mu-domain-mapping' ) . "</p>";
		echo "<strong>" . __( 'Option 1: Update the nameservers of your domain with the following:<button id="popup1">?</button>', 'wordpress-mu-domain-mapping' ) . "</strong>";
		echo "<p>" . __( 'Name server 1 : ns1.cprapid.com', 'wordpress-mu-domain-mapping' ) . "</p>";
		echo "<p>" . __( 'Name server 2 : ns2.cprapid.com', 'wordpress-mu-domain-mapping' ) . "</p>";
		echo "<strong>" . __( 'Option 2: Modify the IP address to enable the transfer of the purchased domain to your website.<button id="popup2">?</button>', 'wordpress-mu-domain-mapping' ) . "</strong>";
		//$dm_ipaddress = get_site_option( 'dm_ipaddress', 'IP not set by admin yet.' );
		echo "<p>" . __( 'IP Address : 72.167.135.176', 'wordpress-mu-domain-mapping' ) . "</p>";
		echo "<p>" . __( 'Instruction : You Need to change your domain DNS and you will need to add DNS "A" records pointing at the IP addresses of this server', 'wordpress-mu-domain-mapping' ) . "</p>";
		
		$dm_ipaddress = '72.167.135.176';
	...
	echo '<p>' . sprintf( __( '<strong>Note:</strong> Wait for 24 Hours to Propogate your website with domain.', 'wordpress-mu-domain-mapping' ), dm_idn_warning() ) . "</p>";
	//echo '<p>' . sprintf( __( '<strong>Note:</strong> %s', 'wordpress-mu-domain-mapping' ), dm_idn_warning() ) . "</p>";
	echo "</div>";
}
