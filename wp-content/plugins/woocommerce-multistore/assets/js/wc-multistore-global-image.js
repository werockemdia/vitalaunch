...
;(function (wp, $) {
    ...
    gm.controller.GlobalMediaLibary = wp.media.controller.Library.extend({
        defaults: _.defaults({
            id: 'global-image',
            title: wp.media.view.l10n.globalImageTitle,
            multiple: true,
            editable: false,
            ...
            library: wp.media.query({ 'global_image': true })
    ...
    wp.media.view.MediaFrame.Post = oldMediaFrame.extend({
        ...
        initialize: function () {
            ...
            this.on('content:create:global-image', this.createGlobalMediaContent, this);
            this.on('content:render:global-image', this.renderGlobalMediaContent, this);
        },
