...
if(empty($saved_methods)){ $count_methods = ""; }else{
    $count_methods = count($saved_methods['cc']);
}
...
<?php if ( $has_methods ) : ?>
	...
	<?php if($count_methods >= 2) { ?>
	<strong>Notice : </strong> Your Limit Exceed to add payment methods.
	<?php } ?>
