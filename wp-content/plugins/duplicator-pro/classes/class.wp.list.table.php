...
/**
     ...
     * @return int
     */
    protected static function get_items_per_page($option, $default = 20)
    {
    ...
    protected function pagination($which)
    {
        ...
        if ('bottom' === $which) {
            ...
            ob_start();
            ?>
            <label for="current-page-selector" class="screen-reader-text"><?php _e('Current Page', 'duplicator-pro'); ?></label>
            <input 
                class="current-page" 
