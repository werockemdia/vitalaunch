...
<div class="wrap dup-wrap dup-support-all"> 
    <table class="debug-toolbar">
        <tr>
            ...
            <td>
                <input type="button" class="button button-small" value="<?php esc_attr_e('Run Tests', 'duplicator-pro'); ?>" onclick="Duplicator.Debug.RunTests()" />
                <input type="button" class="button button-small" value="<?php esc_attr_e('Refresh Page', 'duplicator-pro'); ?>" onclick="window.location.reload();" />
            </td>
