                                    ...
                                    <label for="<?php echo $lbl_id; ?>">
                                        <?php
                                            ...
                                            echo ($storage->isLocal())
                                                ? "<sup title='{$langLocalDefaultMsg}'>" . ViewHelper::disasterIcon(false, ['fa-fw', 'fa-sm']) . "</sup>"
                                                : '';
                                        ?>
                                    </label>
                                </td>
                ...
                <p class="description" style="width:800px">
                    ...
                    printf(
                        __(
                            ...
                            check out the free web monitoring tools found on our %1$spartners page%2$s.',
                            'duplicator-pro'
                        ),
                        '<a href="' . DUPLICATOR_PRO_DUPLICATOR_DOCS_URL . 'what-services-and-products-complement-the-duplicator/" target="_blank">',
                        '</a>'
                    );
                    ?>
                </p>
