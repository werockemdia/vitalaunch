                ...
                <tr id='detail-<?php echo $schedule->getId() ?>' class='<?php echo ($i % 2) ? 'alternate' : ''; ?> schedule-detail'>
                    <td colspan="5">
                        ...
                        <table style="line-height: 15px">
                            <tr>
                                <td><b><?php echo __('Package Template:', 'duplicator-pro'); ?></b></td>
                                <td colspan="3"><?php echo esc_html($template->name); ?></td>
                            </tr>
                            <tr>
                                <td><b><?php echo __('Summary:', 'duplicator-pro'); ?></b></td>
                                <td colspan="3"><?php echo sprintf(__('Runs %1$s', 'duplicator-pro'), $schedule->get_repeat_text()); ?></td>
                            </tr>
                            <tr>
                                <td><b><?php echo __('Last Ran:', 'duplicator-pro') ?></b></td>
                                <td><?php echo $schedule->get_last_ran_string(); ?></td>
                            </tr>
                            <tr>
                                <td><b><?php echo __('Times Run:', 'duplicator-pro') ?></b></td>
        ...
        <tfoot>
            <tr>
                <th colspan="7" style="text-align:right; white-space: nowrap; font-size:12px">
                    <?php
                    echo __('Total', 'duplicator-pro') . ': ' . $schedule_count . ' | ';
                    echo __('Active', 'duplicator-pro') . ': ' . $active_count . ' | ';
                    echo __("Time", 'duplicator-pro') . ': ' . '<span id="dpro-clock-container"></span>';
                    ?>
                </th>
            </tr>
        </tfoot>
